<!-- src/components/comercializadora/LoteAprobacionComercializadoraModal.vue -->
<script setup>
import { ref } from 'vue'
          ...
          <div class="p-4 sm:p-6 space-y-6">
            ...
            <div class="input-group">
              ...
              <p class="input-helper">
                Ejemplo: "Lote aprobado. Coordinar horario de llegada", "Verificar documentación en recepción"
              </p>
            </div>
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-sm text-white/95">
                    Al aprobar este lote, se notificará a la cooperativa y al socio que la comercializadora está lista para recibir el mineral.
