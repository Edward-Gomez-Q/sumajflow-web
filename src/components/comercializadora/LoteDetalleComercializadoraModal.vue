...
const destinoMapa = computed(() => {
  if (!lote.value || 
      !lote.value.comercializadoraBalanzaLatitud || 
      !lote.value.comercializadoraBalanzaLongitud ||
      !lote.value.comercializadoraAlmacenLatitud ||
      !lote.value.comercializadoraAlmacenLongitud) return null
  
  return {
    id: lote.value.comercializadoraId,
    razonSocial: lote.value.comercializadoraNombre,
    latitudAlmacen: lote.value.comercializadoraAlmacenLatitud,
    longitudAlmacen: lote.value.comercializadoraAlmacenLongitud,
    latitudBalanza: lote.value.comercializadoraBalanzaLatitud,
    longitudBalanza: lote.value.comercializadoraBalanzaLongitud,
    municipio: lote.value.comercializadoraMunicipio
  }
})
              ...
              <div class="bg-base rounded-xl p-4 border border-border shadow-sm">
                ...
                <div class="grid sm:grid-cols-2 gap-3 text-sm">
                  ...
                  <div v-if="lote.fechaAprobacionDestino">
                    <p class="text-xs text-tertiary">Aprobación Comercializadora</p>
