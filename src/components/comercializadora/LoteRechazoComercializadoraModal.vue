<!-- src/components/comercializadora/LoteRechazoComercializadoraModal.vue -->
<script setup>
import { ref } from 'vue'
...
// Motivos predefinidos específicos para comercializadora
const motivosPredefinidos = [
  'No contamos con espacio de almacenamiento disponible',
  'El tipo de mineral no corresponde a nuestro mercado',
  'El precio actual del mercado no es favorable',
  'Falta documentación legal requerida para la venta',
  'No tenemos demanda actual para este tipo de mineral',
  'El volumen es insuficiente para una transacción comercial',
  'Problemas con certificaciones de calidad del mineral',
  'Tenemos sobrecarga de inventario actual'
]
          ...
          <div class="p-4 sm:p-6 space-y-6">
            ...
            <div class="input-group">
              ...
              <textarea
                ...
                rows="5"
                placeholder="Explica por qué la comercializadora rechaza este lote..."
                class="resize-none"
              ...
              <p v-else class="input-helper">
                Este motivo será visible para la cooperativa y el socio. Sé claro y específico (mínimo 10 caracteres).
              </p>
            </div>
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-sm text-white/95">
                    Al rechazar este lote, la cooperativa y el socio serán notificados inmediatamente con el motivo especificado.
                    El lote pasará a estado <strong>"Rechazado"</strong> y no podrá ser procesado. El socio
                    deberá crear un nuevo lote si desea realizar el transporte a otro destino.
                  </p>
                </div>
              </div>
            </div>
