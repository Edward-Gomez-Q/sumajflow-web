<!-- src/components/ingenio/LoteRechazoIngenioModal.vue -->
<script setup>
import { ref } from 'vue'
...
// Motivos predefinidos específicos para ingenio
const motivosPredefinidos = [
  'No contamos con capacidad de procesamiento en este momento',
  'El tipo de mineral no coincide con nuestras capacidades',
  'El peso estimado excede nuestra capacidad actual de almacenamiento',
  'La planta está en mantenimiento programado',
  'No procesamos este tipo de mineral complejo',
  'Falta documentación técnica del mineral',
  'El volumen es insuficiente para procesamiento rentable',
  'Tenemos sobrecarga de lotes programados'
]
          ...
          <div class="p-4 sm:p-6 space-y-6">
            ...
            <div class="input-group">
              ...
              <textarea
                ...
                rows="5"
                placeholder="Explica por qué el ingenio rechaza este lote..."
                class="resize-none"
