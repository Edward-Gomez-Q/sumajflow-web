    ...
    <div class="bg-surface border border-border rounded-lg p-4">
      ...
      <ul class="space-y-2 text-sm text-secondary">
        <li class="flex items-start gap-2">
          ...
          <span>Usa el botón "Usar mapa" para seleccionar puntos visualmente</span>
        </li>
        <li class="flex items-start gap-2">
          <ChevronRight class="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
          <span>Busca ubicaciones específicas usando el buscador del mapa</span>
        </li>
        <li class="flex items-start gap-2">
          <ChevronRight class="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
          <span>Define los límites siguiendo el perímetro de tu concesión minera</span>
        </li>
        <li class="flex items-start gap-2">
          <ChevronRight class="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
          <span>Asigna colores diferentes a cada sector para identificarlos fácilmente</span>
        </li>
      </ul>
    </div>
  </div>
