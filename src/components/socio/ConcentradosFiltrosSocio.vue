<!-- src/components/socio/ConcentradosFiltrosSocio.vue -->
<script setup>
...
// Estados disponibles para socio (sin estados internos del ingenio)
const estadosDisponibles = [
  { value: 'en_camino_a_planta', label: 'En camino a planta' },
  { value: 'en_proceso', label: 'En proceso' },
  { value: 'esperando_reporte_quimico', label: 'Esperando reporte químico' },
  { value: 'reporte_quimico_registrado', label: 'Reporte químico registrado' },
  { value: 'listo_para_liquidacion', label: 'Listo para liquidación' },
  { value: 'liquidacion_servicio_solicitada', label: 'Liquidación solicitada' },
  { value: 'liquidacion_servicio_en_revision', label: 'Liquidación en revisión' },
  { value: 'servicio_ingenio_liquidado', label: 'Servicio liquidado' },
  { value: 'servicio_ingenio_pagado', label: 'Servicio pagado' },
...
const aplicarFiltros = () => {
  emit('aplicar', { 
    ...
    page: 0 // Reset a primera página al filtrar
  })
