...
import LoteFormModal from '@/components/socio/LoteFormModal.vue'
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p class="text-secondary mt-1 text-sm sm:text-base">
              Administra tus solicitudes de transporte de mineral
            </p>
          </div>
          <div class="flex gap-2">
            ...
            />
            <button @click="openCreateModal" class="btn flex items-center gap-2 justify-center">
              <Plus class="w-5 h-5" />
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div v-if="lotesStore.lotes.length === 0 && !lotesStore.loading" class="col-span-full text-center py-12">
          ...
          <p class="text-sm text-secondary mb-4">
            Intenta ajustar los filtros o crea un nuevo lote
          </p>
          <button @click="openCreateModal" class="btn-outline px-4 py-2 flex items-center gap-1 mx-auto">
            <Plus class="w-4 h-4" />
            Crear lote
          </button>
        </div>
